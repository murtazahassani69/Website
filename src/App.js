...
import CVTemplateJallow2 from './Routes/Components/JallowTemplate1';
import CVAnimateJallow from './Routes/Components/TempAnimateJa3'
    ...
    <Router>
      <div className="App">
        <Switch>
          ...
          <Route path='/jallow-animate' exact component={CVAnimateJallow} />
